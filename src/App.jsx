...
function Login({ cfg }) {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: COLORS.bg, backgroundImage: `url("${pattern}")`, fontFamily: "Inter, sans-serif", padding: 16 }}>
      <form onSubmit={submit} style={{ background: "#fff", padding: "34px 38px", borderRadius: 20, width: "100%", maxWidth: 380, border: `1px solid ${COLORS.border}`, boxShadow: "0 10px 40px rgba(31,81,59,0.08)" }}>
